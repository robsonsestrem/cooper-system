...
@ManagedBean(name = "MBmapaAssociados")
public class MapaAssociadosBean implements Serializable {
    ...
    public void init() {
        ...
        if (validaAcesso) {
            ...
            try {
                listaCoordenadas = busca.listCoordenadasAssoc();
