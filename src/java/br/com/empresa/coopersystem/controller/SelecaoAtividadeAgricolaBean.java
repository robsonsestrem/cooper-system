...
@ManagedBean(name = "MBselecaoAtividadeAgricola")
@ViewScoped
public class SelecaoAtividadeAgricolaBean implements Serializable {
    ...
    public void pesquisar() {
        try {
            ...
            atividadesFiltradas = atividades.pesquisaAtividadeAgricola(producao);
    ...
    public void abrirDialogo() {
        ...
        RequestContext.getCurrentInstance().openDialog("selecaoAtividadeAgricultura", opcoes, null);// aponta a página xhtml.
    }
